...
| [Deep run](interactive.html#deep-run) | [Deep agent runbook](deep-agent-runbook.md) | Long-horizon run stages and ownership. | Keep stage ownership interactive. |
...
| [Labs](interactive.html#labs) | [Deep agent lab](deep-agent-lab.md), [Subagent handoff simulator](subagent-handoff-simulator.md), [Implementation lab](implementation-lab.md) | Harness anatomy, subagent handoff, composer, trace, combo map. | Split into smaller markdown-owned labs later. |
