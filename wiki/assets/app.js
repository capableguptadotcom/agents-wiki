...
const assemblyDataSource = window.enterpriseAgentsAssemblyData || { layers: [], scenarios: {} };
const assemblyLayers = assemblyDataSource.layers;
const assemblyScenarios = assemblyDataSource.scenarios;
const lifecycle = [
...
function renderAssemblyWalkthrough(scenarioKey = currentAssemblyScenario, layerKey = currentAssemblyLayer) {
  if (!assemblyLayers.length || !Object.keys(assemblyScenarios).length) {
    document.getElementById("assembly-scenarios").innerHTML = `
      <div class="assembly-missing-data">
        Generate <code>wiki/assets/generated/assembly-data.js</code> from <code>wiki/architecture-assembly-data.md</code> before using this lab.
      </div>
    `;
    document.getElementById("assembly-layers").innerHTML = "";
    document.getElementById("assembly-detail").innerHTML = "<p>Architecture Assembly data is missing.</p>";
    document.getElementById("assembly-record").textContent = "{}";
    document.getElementById("assembly-path").innerHTML = "";
