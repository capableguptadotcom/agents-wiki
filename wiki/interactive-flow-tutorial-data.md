---
title: "Interactive Flow Tutorial Data"
---

This markdown file is the source of truth for the focused interactive tutorial in [Interactive Flow Tutorial](interactive-flow-tutorial.md).

The browser data file is generated by `scripts/generate-flow-tutorial-data.mjs` and is not the durable source. Edit this markdown block first, then regenerate.

```json flow-tutorial-data
{
  "hero": {
    "eyebrow": "Concrete vertical slice",
    "title": "Bed-flow run: from voice intent to verified product state",
    "body": "Switch scenarios and step through the run. Watch which product boundary owns each stop.",
    "cruxTitle": "The crux",
    "cruxBody": "The agent coordinates. Product records decide whether work may continue."
  },
  "steps": [
    {
      "key": "intent",
  ...
  "checklist": [
    {
      "label": "Context is bound before reasoning",
      "step": "context",
      "passWhenStatus": []
    },
    {
      "label": "Authority is checked before tools",
      "step": "authority",
      "passWhenStatus": []
    },
    {
      "label": "Evidence is source-linked",
      "step": "evidence",
      "passWhenStatus": []
    },
    {
      "label": "Approval binds exact payload",
      "step": "policy",
      "passWhenStatus": [
        "recheck_required"
      ]
    ...
    {
      "label": "Workflow owns side effects",
      "step": "workflow",
      "passWhenStatus": []
    },
    {
      "label": "Source truth controls completion",
      "step": "verify",
      "passWhenStatus": [
    ...
    {
      "label": "Learning is reviewed before promotion",
      "step": "learn",
      "passWhenStatus": [
        "memory_rejected"
      ]
  ...
  "readerNote": "If a failure scenario reaches a dangerous action, the architecture is wrong. Your implementation should make the stop boring, explicit, auditable, and testable."
}
```
